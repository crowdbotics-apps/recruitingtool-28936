...
## Project Structure
    ...
    ├── recruitingtool_28936  # Django project configurations
...
1. Clone this repo and `cd recruitingtool_28936`
...
2. Clone this repo and `cd recruitingtool_28936`
